    ...
    <div class="py-12 space-y-8">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            <div class="w-full flex flex-col sm:flex-row sm:items-end gap-4">
                ...
                <a href="{{ route('admin.lista-final') }}" target="_blank"
                   class="inline-flex items-center gap-2 px-3 py-1 rounded-md bg-emerald-700 hover:bg-emerald-800 text-white text-xs font-semibold uppercase tracking-widest shadow transition ease-in-out duration-150 w-full sm:w-fit justify-center sm:ml-2">
