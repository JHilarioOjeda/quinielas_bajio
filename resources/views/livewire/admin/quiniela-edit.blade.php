    ...
    <div class="py-12 space-y-8">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            <div class="w-full flex">
                ...
                <x-button-primary wire:click="saveGeneralDataQuiniela" class="w-fit mt-8 ml-auto !h-fit !p-2 my-auto">
        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
            ...
            @foreach($matches as $index => $match)
                <div class="w-full flex gap-6 md:flex-row mb-3">
                    ...
                    <p class="my-auto font-bold text-xl">VS</p>
                    <div class="w-1/4">
                        <div class="flex flex-col">
                            <p class="text-gray-800 text-right">Equipo visitante:</p>
                    ...
                    <div class="w-1/4 flex justify-between">
                        ...
                        <x-buttondelete wire:click="removeMatch({{ $index }})" class="w-fit mt-auto !h-fit !p-1" title="Eliminar partido">
                        </x-buttondelete>
                    </div>
                </div>
            @endforeach
            ...
            <div class="mt-5">
                ...
                <div class="w-full flex gap-6 md:flex-row mb-3">
                    ...
                    <div class="w-1/4">
                        <div class="flex flex-col">
                            <p class="text-gray-800 ml-auto">Equipo visitante:</p>
                            <div class="flex items-center gap-2">
