<nav x-data="{ open: false, userMenuOpen: false }" class="bg-white border-b border-gray-100">
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        <div class="pt-4 pb-1 border-t border-gray-200">
            <button type="button" @click="userMenuOpen = ! userMenuOpen" class="flex items-center w-full px-4 py-2 justify-between">
                <div class="flex items-center">
                ...
                <svg class="size-5 text-gray-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                    ...
                    <path :class="{'hidden': userMenuOpen, 'inline-flex': ! userMenuOpen }" class="inline-flex" stroke-linecap="round" stroke-linejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                    <!-- Flecha hacia arriba (abierto) -->
                    <path :class="{'hidden': ! userMenuOpen, 'inline-flex': userMenuOpen }" class="hidden" stroke-linecap="round" stroke-linejoin="round" d="M4.5 15.75l7.5-7.5 7.5 7.5" />
                </svg>
            </button>

            <div class="mt-3 space-y-1" x-show="userMenuOpen">
                <!-- Account Management -->
