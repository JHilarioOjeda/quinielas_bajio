<div class="relative w-full">
    <span class="absolute inset-y-0 left-1 flex items-center">
        <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" version="1.1" viewBox="-10 -200 970 960" class="size-6 text-primarycolor">
    ...
    <input {!! $attributes->merge(['class' => 'block bg-primarylight border border-gray-300 rounded-lg pl-8 py-2 focus:border-primarycolor focus:ring-primarycolor focus:ring-1 ']) !!}" 
